...
public class Funcionario extends Pessoa {
	...
	public String toString() {// retorna os dados do Funcionario
		return "\nID: " + this.getId() + "\nNome: " + super.getNome() + "\nCPF: " + super.getCpf() + "\nTelefone: ("
				+ super.getContato().getTelefone().getDd() + ") " + super.getContato().getTelefone().getNumero()
				+ "\nEmail: " + super.getContato().getEmail() + "\n== EndereÃ§o ==" + "\nEstado: "
				+ super.getEndereco().getEstado() + "\nCidade: " + super.getEndereco().getCidade() + "\nLogradouro: "
				+ super.getEndereco().getLogradouro() + "\nComplemento: " + super.getEndereco().getComplemento()
				+ "\nNÃºmero: " + super.getEndereco().getNumero() + "\n== salÃ¡rio e carga horÃ¡ria ==" + "\nSalario: "
