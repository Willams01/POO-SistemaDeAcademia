...
public class Academia {
	...
	private List<Cliente> clientesDevendo = new ArrayList<Cliente>();
	...
	public Academia(String nome, Endereco endereco, Contato contato, List<Cliente> clientes,
	...
	public String pagarFuncionario(String CPF) {
		for (Funcionario f : this.funcionarios) {
			...
			return "FuncionÃ¡rio pago com sucesso!";
		}
		return "FuncionÃ¡rio jÃ¡ foi pago esse mÃªs";
	}
	...
	public String clientePagar(String CPF) throws cpfNaoExisteException {
		...
		if (existe != false) {
			...
			throw new cpfNaoExisteException("O CPF nÃ£o estÃ¡ cadastrado.\n");
		}
	...
	public String toString() {
		return "\n Nome: " + this.nome + "\n Logradouro: " + this.endereco.getLogradouro() + "\n NÃºmero: "
				...
				+ this.contato.getTelefone().getDd() + " " + this.contato.getTelefone().getNumero();
	}
