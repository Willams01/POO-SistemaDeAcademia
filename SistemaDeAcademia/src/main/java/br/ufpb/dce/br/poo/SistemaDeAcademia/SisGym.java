...
public class SisGym {
	...
	public static void main(String[] args) {
		Gravadores gravador = new Gravadores();

		String nomeAcademia = JOptionPane.showInputDialog("Digite o nome da Academia"); // Inicia pedindo o nome da
																						// Academia
		Academia academia = new Academia(nomeAcademia);

		boolean sair = false; // condicao para o menu geral funcionar
		while (!sair) {
			...
			case 1: // Entrando no Menu da Academia
				...
				boolean sairAcademia = false; // Condicao para sair do menu da academia
				while (!sairAcademia) {

					int escolhaAcademia = Integer.parseInt(
							JOptionPane.showInputDialog("Menu Academia " + academia.getNome() + "\n" + "1 - Dados\n"
									+ "2 - Alterar Nome\n" + "3 - Alterar Contato\n" + "4 - Alterar Endereço\n"
									+ "5 - Contas a receber\n" + "6 - Contas a pagar\n" + "0 - Voltar"));
					...
					case 2:
						...
						JOptionPane.showMessageDialog(null,
								"O nome da Academia foi alterado para " + academia.getNome());
					...
					case 3:
						...
						int novoNumero = Integer
								.parseInt(JOptionPane.showInputDialog("Digite o novo Telefone da Academia: "));
						...
						JOptionPane.showMessageDialog(null,
								"O Telefone da Academia foi alterado para "
										+ academia.getContato().getTelefone().getDd() + " "
										+ academia.getContato().getTelefone().getNumero());
						JOptionPane.showMessageDialog(null,
								"O Email da Academia foi alterado para " + academia.getContato().getEmail());
					...
					case 4:
						...
						int novoNumeroAcademia = Integer
								.parseInt(JOptionPane.showInputDialog("Digite o Número da Academia"));
						...
						Endereco novoEdereco = new Endereco(novoLogradouroAcademia, novoNumeroAcademia,
								novoComplementoAcademia, novoBairroAcademia, novaCidadeAcademia, novoEstadoAcademia);
					...
					case 0:
						sairAcademia = true; // CondiÃ§Ã£o apra voltar ao menu anterior
					}
				}
				break;
			...
			case 2: // Entra no menu de Funcionário
				...
				while (!sairFuncionario) {
					int escolhaFuncionario = Integer.parseInt(JOptionPane
							.showInputDialog("Menu Funcionários " + academia.getNome() + "\n" + "1 - Cadastrar\n"
									+ "2 - Listar\n" + "3 - A Pagar\n" + "4 - Efetuar Pagamento \n" + "0 - Voltar"));
					...
					case 1:
						...
						Endereco enderecoFunc = new Endereco(logradouroFunc, numeroFunc, complementoFunc, bairroFunc,
								cidadeFunc, estadoFunc);

						Funcionario f = new Funcionario(id, nome, CPF, contato, enderecoFunc, dataNasciFunc, valor,
								cargaHoraria);
					...
					case 2: // Esta opçao vai listar todos os funcionários cadastrados na academia
					...
					case 3: // Esta opcaoo vai listar todos os funcionários que ainda não receberam o
							// salário
					...
					case 4: // Esta opcao vai dar baixa no pagamento do funcionario
			...
			case 3:
				...
				while (!sairEquipamento) {
					int escolhaEquipamento = Integer.parseInt(
							JOptionPane.showInputDialog("Menu de Equipamentos da Academia " + academia.getNome() + "\n"
									+ "1 - Cadastrar\n" + "2 - Remover\n" + "3 - Listar\n" + "0 - Voltar"));
					...
					case 1:
						...
						int IdEquipamento = Integer
								.parseInt(JOptionPane.showInputDialog("Digite um ID para o Equipamento: "));
						...
						double pesoMaterial = Double
								.parseDouble(JOptionPane.showInputDialog("Digite o peso do material:"));
						String descricaoEquipamento = JOptionPane.showInputDialog("Digite a descrição do equipamento");
						Equipamento e = new Equipamento(nomeEquipamento, tipoEquipamento, pesoMaterial, IdEquipamento,
					...
					case 2:
						...
						int idEquipamentoRemover = Integer
								.parseInt(JOptionPane.showInputDialog("Digite o ID do Equipamento para remover"));
			...
			case 4: // cliente
				...
				while (!sairCliente) {
					int escolhaCliente = Integer.parseInt(
					...
					case 1:
						...
						int opcaoPlano = Integer.parseInt(JOptionPane
								.showInputDialog("Opçõees de Plano:" + "\n1-Plano Famalia" + "\n2-Plano Universitário"
										+ "\n3-Plano Padrão" + "\n4-Plano Natação" + "\n5-Plano Luta"));
						...
						Endereco enderecoCliente = new Endereco(logradouroCliente, numeroCliente, complementoCliente,
								bairroCliente, cidadeCliente, estadoCliente);
						Cliente c = new Cliente(id, nomeCliente, CPFCliente, contatoCliente, enderecoCliente,
								dataNasciCliente, planoCliente);
			...
			case 0:// Sair
				...
				for (Cliente c : academia.getClientes()) {
					try {
						gravador.gravarClientes(academia.getClientes(), c.getNome());
						JOptionPane.showMessageDialog(null,
								"Cliente - Arquivos gravados com sucesso: " + c.getNome() + ".txt");
					} catch (IOException e) {
						JOptionPane.showMessageDialog(null, e.getMessage());
					}
				}
				for (Funcionario f : academia.getFuncionarios()) {
					try {
						gravador.gravarFuncionarios(academia.getFuncionarios(), f.getNome());
						JOptionPane.showMessageDialog(null,
								"Funcionario - Arquivos gravados com sucesso: " + f.getNome() + ".txt");
					} catch (IOException e) {
						JOptionPane.showMessageDialog(null, e.getMessage());
					}
				}
				for (Equipamento eq : academia.getEquipamentos()) {
					try {
						gravador.gravarEquipamentos(academia.getEquipamentos(), eq.getNome());
						JOptionPane.showMessageDialog(null,
								"Equipamento - Arquivos gravados com sucesso: " + eq.getNome() + ".txt");
					} catch (IOException e) {
						JOptionPane.showMessageDialog(null, e.getMessage());
					}
				}
